...
namespace AchilliosOmega.Discord.Services
{
    public class TaskSchedulerService
    {
        ...
        public TaskSchedulerService(ISchedulerFactory schedulerFactory, IJobFactory jobFactory, IEnumerable<JobSchedule> jobSchedules)
        {
        ...
        public async Task InitializeAsync()
        {
            try
            {
                TaskScheduler = await _schedulerFactory.GetScheduler();
                ...
                foreach (var jobSchedule in _jobSchedules)
                {
                    ...
                    await TaskScheduler.ScheduleJob(job, trigger);
                }
